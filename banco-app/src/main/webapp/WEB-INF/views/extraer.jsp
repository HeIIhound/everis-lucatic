				...
				<div class="oper">
					<form method="post" action="operativa" name="extraerForm">
						<strong>Cantidad: </strong> <input class="textbox" name="cantidad"
							type="number" maxlength="22" size="30" max="-0.01" step=".01"
						...
						<br> <input type="hidden" name="idCuenta"
							...
							name="operativa" value="extraer" />
						<button type="submit" class="btn" value="Extraer"
							onclick="return numerosNegativos(event);">Extraer</button>
					</form>
				</div>
				<div class="fot">
